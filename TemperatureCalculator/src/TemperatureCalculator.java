...
public class TemperatureCalculator {
	...
	private void initialize() {
		...
		frmTemperatureCalculator.setIconImage(Toolkit.getDefaultToolkit().getImage("D:\\Sohanur\\TemperatureCalculator\\logo.png"));
		...
		JLabel lblDevelopByMd = new JLabel("Develop by Md. Sohanur Rahman");
